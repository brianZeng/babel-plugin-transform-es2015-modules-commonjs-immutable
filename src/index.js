...
export default function ({types}) {
  let REASSIGN_REMAP_SKIP = Symbol(),t=types;
          ...
          for (let source in imports) {
            ...
            if (specifiers.length) {
              ...
              if(remapVariableDeclarators.length){
                topNodes.push(t.variableDeclaration('var',remapVariableDeclarators));
              }
            } else {
              // bare import
